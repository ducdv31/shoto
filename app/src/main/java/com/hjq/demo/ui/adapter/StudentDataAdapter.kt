...
import com.hjq.demo.databinding.ItemStudentDataBinding
import com.hjq.demo.model.Student

class StudentDataAdapter(context: Context) :
    AppAdapter<Student>(context) {

    lateinit var onClickListener: OnClickListener

    inner class ViewHolder(val binding: ItemStudentDataBinding) :
        ...
        override fun onBindView(position: Int) {
            ...
            binding.tvCodeDk.text = item.maDk
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AppViewHolder {
        val binding =
            ItemStudentDataBinding.inflate(LayoutInflater.from(parent.context), parent, false)
